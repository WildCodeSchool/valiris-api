                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                      <tr style="border-collapse:collapse"> 
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                          ...
                          ${body.apartmentName
                            ? lang === 'en'
                              ? `<span style='color:#319797'>Apartment:</span> ${body.apartmentName}`
                          ...
                          ${body.startDate
                            ? lang === 'en'
                              ...
                              : ''}
                          <br><span style='color:#319797'>Message :</span> ${body.message}</strong>
                          <br><br>${lang === 'en' ? 'Regards, ' : 'Cordialement, '}
                          <strong>
                            <span style="font-size:16px;color:#319797"><br>Valiris Résidence</span>
                            </strong></p><br><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:28px;color:#2980D9"><br></p></td> 
                        </tr>
                        </table></td> 
                      </tr>  
                    </table></td> 
